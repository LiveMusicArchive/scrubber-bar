 ...
 * @return {boolean}
 */
export function isCustomElementDecorator(node) {
 ...
 * @return {boolean}
 */
export function isCustomElement(context, node, jsdoc) {
 ...
 * @return {boolean}
 */
export function isNativeCustomElement(node) {
