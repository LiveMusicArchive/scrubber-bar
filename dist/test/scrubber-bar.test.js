...
describe('ScrubberBar', () => {
    ...
    it('dispatches userInteractionStarted event on user mousedown', async () => {
      ...
      <scrubber-bar></scrubber-bar>
    `));
        const rangeSlider = (_a = el.shadowRoot) === null || _a === void 0 ? void 0 : _a.getElementById('slider');
        const event = new MouseEvent('mousedown');
        // we have to do this in a setTimeout so the event listener below has a chance to listen
        setTimeout(() => {
            rangeSlider === null || rangeSlider === void 0 ? void 0 : rangeSlider.dispatchEvent(event);
        });
    ...
    `));
        ...
        // we have to do this in a setTimeout so the event listener below has a chance to listen
        setTimeout(() => {
            rangeSlider === null || rangeSlider === void 0 ? void 0 : rangeSlider.dispatchEvent(inputEvent);
        });
    ...
    `));
        const sectionMarkers = (_a = el.shadowRoot) === null || _a === void 0 ? void 0 : _a.querySelectorAll('section-marker');
        expect(sectionMarkers === null || sectionMarkers === void 0 ? void 0 : sectionMarkers.length).to.equal(6);
...
//# sourceMappingURL=scrubber-bar.test.js.map